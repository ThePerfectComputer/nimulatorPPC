...
proc writeUint8*(membus : Membus, byte_address : uint32, value : uint8, endianness : ENDIAN) =
  membus.writeByte(byte_address, value)

proc writeUint16*(membus : Membus, byte_address : uint32, value : uint16, endianness : ENDIAN) =
...
proc writeUint32*(membus : Membus, byte_address : uint32, value : uint32, endianness : ENDIAN) =
  var start_address = byte_address
...
proc writeUint64*(membus : Membus, byte_address : uint32, value : uint64, endianness : ENDIAN) =
  var start_address = byte_address
